                ...
                return (
                    <span
                        ...
                        style={{
                            ...
                            borderWidth: '1px',
                            borderColor: `var(--foreground) / ${borderOpacity / 100
                                })`,
                            top: '50%',
                            left: '50%',
...
const TechOrbitDisplay = memo(function TechOrbitDisplay({
    ...
    return (
        <div className='relative flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-lg'>
            <span className='pointer-events-none whitespace-pre-wrap bg-gradient-to-b from-white to-gray-500 bg-clip-text text-center text-7xl font-semibold leading-none text-transparent dark:from-white dark:to-slate-900/10'>
                {text}
            </span>
        ...
        <div className='max-md:w-full flex flex-col gap-4 w-96 mx-auto'>
            ...
            {googleLogin && (
                <>
                    ...
                    >
                        <button
                            className='g-button group/btn bg-transparent w-full rounded-md border h-10 font-medium outline-none hover:cursor-pointer'
                            type='button'
            ...
            <form onSubmit={handleSubmit}>
                <div className={`grid grid-cols-1 md:grid-cols-${fieldPerRow} mb-4`}>
                    {fields.map((field) => (
...
const AuthTabs = memo(function AuthTabs({
    ...
    return (
        <div className='flex max-lg:justify-center w-full md:w-auto'>
            <div className='w-full h-full flex flex-col justify-center items-center max-lg:px-[10%]'>
                <AnimatedForm
                    {...formFields}
                    fieldPerRow={1}
